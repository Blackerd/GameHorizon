          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/3">
              <div className="bg-[#202020] rounded-lg p-6 sticky top-24">
                ...
                <button className="w-full bg-[#0078F2] text-white py-3 rounded font-semibold hover:bg-[#0060c7] transition-colors">
                ...
                <div className="mt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <div className="bg-[#303030] px-3 py-2 rounded text-sm">Visa</div>
                    <div className="bg-[#303030] px-3 py-2 rounded text-sm">MasterCard</div>
                    <div className="bg-[#303030] px-3 py-2 rounded text-sm">PayPal</div>
                    <div className="bg-[#303030] px-3 py-2 rounded text-sm">Momo</div>
                  </div>
                </div>
              </div>
            </div>
